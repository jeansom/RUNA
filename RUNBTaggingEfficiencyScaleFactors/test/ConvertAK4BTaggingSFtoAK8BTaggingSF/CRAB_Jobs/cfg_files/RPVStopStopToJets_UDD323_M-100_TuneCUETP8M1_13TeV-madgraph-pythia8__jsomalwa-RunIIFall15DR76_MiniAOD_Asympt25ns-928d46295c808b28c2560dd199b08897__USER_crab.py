...
config.JobType.psetName = '/uscms_data/d3/jsomalwa/SFb80X/test8116/CMSSW_8_0_12/src/RUNA/RUNBTaggingEfficiencyScaleFactors/test/ConvertAK4BTaggingSFtoAK8BTaggingSF/CRAB_Jobs/cfg_files/CMSSW_cfg.py'

config.JobType.pluginName = 'Analysis'

### The Input Files (JECs)
