...
class RUNTriggerStudies : public edm::EDAnalyzer {

	public:
		explicit RUNTriggerStudies(const edm::ParameterSet&);
		~RUNTriggerStudies() {}
...
RUNTriggerStudies::RUNTriggerStudies(const edm::ParameterSet& iConfig):
...
void RUNTriggerStudies::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
DEFINE_FWK_MODULE(RUNTriggerStudies);
