...
if __name__ == '__main__':
	...
	#Samples[ 'B2GSingleMuonF' ] = [ '/SingleMuon/vorobiev-Run2016F-23Sep2016-v1_B2GAnaFW_80X_v2p4-e26b2444814d18badce3899570108664/USER', 10, 'Spring16_23Sep2016EFV2' ]
	...
	for sam in processingSamples:
		...
		procName = dataset.split('/')[1]+dataset.split('/')[2].replace( dataset.split('/')[2].split('-')[0], '').split('_')[0]+'_'+args.version
