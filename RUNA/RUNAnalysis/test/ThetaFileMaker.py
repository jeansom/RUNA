...
def ThetaFileMaker( chan, chanCuts, bins, minBin, maxBin, Xcut, Ycut, isMC=True ):
    ...
    var_arrayMass = [ "prunedMassAve", Xcut[0], 12, 50., 350., Xcut[2], Xcut[3], Xcut[4] ] # For making B,D plot
    ...
    MakeEstPlots( EstMass, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputs/Mass"+chan,  False )

    MakeFitPlots( EstMassWJUp, FMassWJUp, binsMass, "prunedMassAve", Xcut[0], var_arrayMass, presel+"&"+chanCutsTemp, Ycut[0]+">"+Ycut[1], cutsB, cutsD, cut, 0, "", "",  "outputs/MassWJUp"+chan, False )
    MakeEstPlots( EstMassWJUp, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputs/MassWJUp"+chan, False )

    MakeFitPlots( EstMassWJDn, FMassWJDn, binsMass, "prunedMassAve", Xcut[0], var_arrayMass, presel+"&"+chanCutsTemp, Ycut[0]+">"+Ycut[1], cutsB, cutsD, cut, 0, "", "", "outputs/MassWJDn"+chan, False )
    MakeEstPlots( EstMassWJDn, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputs/MassWJDn"+chan, False )

    MakeFitPlots( EstMassTTUp, FMassTTUp, binsMass, "prunedMassAve", Xcut[0], var_arrayMass, presel+"&"+chanCutsTemp, Ycut[0]+">"+Ycut[1], cutsB, cutsD, cut, 0, "", "", "outputs/MassTTUp"+chan, False )
    MakeEstPlots( EstMassTTUp, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputs/MassTTUp"+chan, False )

    MakeFitPlots( EstMassTTDn, FMassTTDn, binsMass, "prunedMassAve", Xcut[0], var_arrayMass, presel+"&"+chanCutsTemp, Ycut[0]+">"+Ycut[1], cutsB, cutsD, cut, 0, "", "", "outputs/MassTTDn"+chan, False )
    MakeEstPlots( EstMassTTDn, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputs/MassTTDn"+chan, False )

    # Makes root file with basic fits
    FITFILE = TFile( "outputs/LIM_FIT"+chan+".root", "RECREATE" )
    FITFILE.cd()
    ...
    quickplot( TTJets.File, TTJets.Tree, chan__TTBAR__TTScale__up, "prunedMassAve", presel+"&"+cuts+"&"+chanCuts, TTJets.weight+"*1.5" )
    quickplot( TTJets.File, TTJets.Tree, chan__TTBAR__TTScale__down, "prunedMassAve", presel+"&"+cuts+"&"+chanCuts, TTJets.weight+"*.5" )

    if not( "b2" in chan or "t2" in chan ) or True:
        quickplot( WJets.File, WJets.Tree, chan__WJETS__A, "prunedMassAve", presel+"&"+cuts+"&"+chanCuts, WJets.weight )
        quickplot( WJets.File, WJets.Tree, chan__WJETS__WJScale__up__A, "prunedMassAve", presel+"&"+cuts+"&"+chanCuts, WJets.weight+"*1.5" )
        quickplot( WJets.File, WJets.Tree, chan__WJETS__WJScale__down__A, "prunedMassAve", presel+"&"+cuts+"&"+chanCuts, WJets.weight+"*.5" )

        quickplot( WJets.File, WJets.Tree, chan__WJETS, "prunedMassAve", presel+"&"+cutsB, WJets.weight )
        quickplot( WJets.File, WJets.Tree, chan__WJETS__WJScale__up, "prunedMassAve", presel+"&"+cutsB, WJets.weight+"*1.5" )
        quickplot( WJets.File, WJets.Tree, chan__WJETS__WJScale__down, "prunedMassAve", presel+"&"+cutsB, WJets.weight+"*.5" )
    ...
    FILE = TFile( "outputs/LIM_FEED"+chan+".root", "RECREATE" )
    FILE.cd()
    #### Write plots to file    
    chan__DATA.Write()
    chan__QCD.Write()
    ...
    C.SaveAs("outputs/"+chan+"__DATA.png")
    chan__QCD.Draw("hist")
    C.SaveAs("outputs/"+chan+"__QCD.png")
    chan__TTBAR.Draw("hist")
    C.SaveAs("outputs/"+chan+"__TTBAR.png")
    chan__WJETS.Draw("hist")
    C.SaveAs("outputs/"+chan+"__WJets.png")
    chan__QCD__Fit__up.Draw("hist")
    C.SaveAs("outputs/"+chan+"__QCD__Fit__up.png")
    chan__QCD__Fit__down.Draw("hist")
    C.SaveAs("outputs/"+chan+"__QCD__Fit__down.png")
    chan__TTBAR__TTScale__up.Draw("hist")
    C.SaveAs("outputs/"+chan+"__TTBAR__TTScale__up.png")
    chan__TTBAR__TTScale__down.Draw("hist")
    C.SaveAs("outputs/"+chan+"__TTBAR__TTScale__down.png")
    chan__QCD__TTScale__up.Draw("hist")
    C.SaveAs("outputs/"+chan+"__QCD__TTScale__up.png")
    chan__QCD__TTScale__down.Draw("hist")
    C.SaveAs("outputs/"+chan+"__QCD__TTScale__down.png")
    chan__WJETS__WJScale__up.Draw("hist")
    C.SaveAs("outputs/"+chan+"__WJETS__WJScale__up.png")
    chan__WJETS__WJScale__down.Draw("hist")
    C.SaveAs("outputs/"+chan+"__WJETS__WJScale__down.png")
    chan__QCD__WJScale__up.Draw("hist")
    C.SaveAs("outputs/"+chan+"__QCD__WJScale__up.png")
    chan__QCD__WJScale__down.Draw("hist")
    C.SaveAs("outputs/"+chan+"__QCD__WJScale__down.png")
