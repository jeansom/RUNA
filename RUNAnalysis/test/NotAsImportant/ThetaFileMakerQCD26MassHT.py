...
#        i=i+dBin
    ...
    MakeEstPlots( EstMass, "HT", "HT", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputs/"+directory+method+"/Mass"+chan+"_"+scaleName, rhoBinBoundaries, fit, isMC, False, log ) # Makes the actual estimation
