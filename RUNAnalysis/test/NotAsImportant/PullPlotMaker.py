...
if plot:
#    PullPlots.append( [ TFile.Open("outputs/"+directory+"0"+method+"/Massb0t0Lpull.root"), "Zero btags, Zero top-tags, Loose Tau21" ] )
    PullPlots.append( [ TFile.Open("outputs/"+directory+"1"+method+"/Massb0t0Tpull.root"), "Zero btags, Zero top-tags, Tight Tau21" ] )
#    PullPlots.append( [ TFile.Open("outputs/"+directory+"2"+method+"/Massb1t0Lpull.root"), "One btag, Zero top-tags, Loose Tau21" ] )
    PullPlots.append( [ TFile.Open("outputs/"+directory+"3"+method+"/Massb1t0Tpull.root"), "One btag, Zero top-tags, Tight Tau21" ] )
    PullPlots.append( [ TFile.Open("outputs/"+directory+"4"+method+"/Massb2t0pull.root"), "Two btags, Zero top-tags" ] )
    PullPlots.append( [ TFile.Open("outputs/"+directory+"5"+method+"/Massb0t1pull.root"), "Zero btags, One top-tag" ] )
    PullPlots.append( [ TFile.Open("outputs/"+directory+"6"+method+"/Massb1t1pull.root"), "One btag, One top-tag" ] )
    PullPlots.append( [ TFile.Open("outputs/"+directory+"7"+method+"/Massb2t1pull.root"), "Two btags, One top-tag" ] )
    PullPlots.append( [ TFile.Open("outputs/"+directory+"8"+method+"/Massb0t2pull.root"), "Zero btags, Two top-tags" ] )
#    PullPlots.append( [ TFile.Open("outputs/"+directory+"11"+method+"/Massb12t2pull.root"), "One or Two btags, Two top-tags" ] )
    PullPlots.append( [ TFile.Open("outputs/"+directory+"9"+method+"/Massb1t2pull.root"), "One btag, Two top-tags" ] )
    PullPlots.append( [ TFile.Open("outputs/"+directory+"10"+method+"/Massb2t2pull.root"), "Two btags, Two top-tags" ] )

    directory2 = directory.replace("After","Before")
    method2 = method.replace("After","Before")

#    PullPlots2.append( [ TFile.Open("outputs/"+directory2+"0"+method2+"/Massb0t0Lpull.root"), "Zero btags, Zero top-tags, Loose Tau21" ] )
    PullPlots2.append( [ TFile.Open("outputs/"+directory2+"1"+method2+"/Massb0t0Tpull.root"), "Zero btags, Zero top-tags, Tight Tau21" ] )
#    PullPlots2.append( [ TFile.Open("outputs/"+directory2+"2"+method2+"/Massb1t0Lpull.root"), "One btag, Zero top-tags, Loose Tau21" ] )
    PullPlots2.append( [ TFile.Open("outputs/"+directory2+"3"+method2+"/Massb1t0Tpull.root"), "One btag, Zero top-tags, Tight Tau21" ] )
    PullPlots2.append( [ TFile.Open("outputs/"+directory2+"4"+method2+"/Massb2t0pull.root"), "Two btags, Zero top-tags" ] )
    PullPlots2.append( [ TFile.Open("outputs/"+directory2+"5"+method2+"/Massb0t1pull.root"), "Zero btags, One top-tag" ] )
    PullPlots2.append( [ TFile.Open("outputs/"+directory2+"6"+method2+"/Massb1t1pull.root"), "One btag, One top-tag" ] )
    PullPlots2.append( [ TFile.Open("outputs/"+directory2+"7"+method2+"/Massb2t1pull.root"), "Two btags, One top-tag" ] )
#    PullPlots2.append( [ TFile.Open("outputs/"+directory2+"11"+method2+"/Massb12t2pull.root"), "One or Two btags, Two top-tags" ] )
    PullPlots2.append( [ TFile.Open("outputs/"+directory2+"8"+method2+"/Massb0t2pull.root"), "Zero btags, Two top-tags" ] )
    PullPlots2.append( [ TFile.Open("outputs/"+directory2+"9"+method2+"/Massb1t2pull.root"), "One btag, Two top-tags" ] )
    PullPlots2.append( [ TFile.Open("outputs/"+directory2+"10"+method2+"/Massb2t2pull.root"), "Two btags, Two top-tags" ] )
...
#        latex.DrawLatex( .2, .90, "#color[4]{After Theta: Integral="+"{0:.5f}".format(FitMet[i].Integral())+"}" )
    ...
    for i in range(1, avePull.GetNbinsX()+1 ): # Loop through bins in avePull plot
        ...
        avePull.SetBinContent( i, bin/len(PullPlots) ) # Set bin content = bin content/9
...
#        latex.DrawLatex( .15, .78, "#color[2]{#sigma: " + str("%.4f" % FitResultBefore[i].Parameter(2)) + "}" )
    ...
    Results = [] # Results for above fits, unnecessary?
    for i in xrange(len(PullPlots)): # Loops through the 9 regions
        FitMet.append(TH1D("h0"+str(i),"", PullPlots[i][0].Get("Pull_norm").GetNbinsX(), 60, 350 ) ) # Appends an empty TH1D for the pull plot after theta
        for bin in range(0, FitMet[i].GetNbinsX()+1): # Loops through the bins
            FitMet[i].SetBinContent( bin, PullPlots[i][0].Get("Pull_norm").GetBinContent(bin) ) # and fills

        FitMet2.append(TH1D("h1"+str(i),"", PullPlots2[i][0].Get("Pull_norm").GetNbinsX(), 60, 350 ) ) # Appends an empty TH1D for the pull plot before theta
        for bin in range(0, FitMet2[i].GetNbinsX()+1): # Loops through the binds
            FitMet2[i].SetBinContent( bin, PullPlots2[i][0].Get("Pull_norm").GetBinContent(bin) ) # and fills
...
#    T0.Draw("same")
    ...
    C7.SaveAs( "outputs/"+directory+method+"/PullPlotNormMetricAll"+method+".png" )

    ###### FIT METRIC DISTRIBUTION DIV WITH FIT  ######
    ...
    Results = [] # Results for above fits, unnecessary?
    for i in xrange(len(PullPlots)): # Loops through the 9 regions
        FitMet.append(TH1D("h0"+str(i),"", PullPlots[i][0].Get("fitMetric_div").GetNbinsX(), 60, 350 ) ) # Appends an empty TH1D for the pull plot after theta
        for bin in range(0, FitMet[i].GetNbinsX()+1): # Loops through the bins
            FitMet[i].SetBinContent( bin, PullPlots[i][0].Get("fitMetric_div").GetBinContent(bin) ) # and fills

        FitMet2.append(TH1D("h1"+str(i),"", PullPlots2[i][0].Get("fitMetric_div").GetNbinsX(), 60, 350 ) ) # Appends an empty TH1D for the pull plot before theta
        for bin in range(0, FitMet2[i].GetNbinsX()+1): # Loops through the binds
            FitMet2[i].SetBinContent( bin, PullPlots2[i][0].Get("fitMetric_div").GetBinContent(bin) ) # and fills
...
#    T0.Draw("same")
    ...
    C7.SaveAs( "outputs/"+directory+method+"/PullPlotDivMetricAll"+method+".png" )
