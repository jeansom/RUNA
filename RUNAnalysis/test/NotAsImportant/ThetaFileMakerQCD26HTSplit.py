...
def ThetaFileMaker( chan, scaleName, chanCuts, bins, minBin, maxBin, Xcut, Ycut, tau21, prelimFit, fitBins, HT, Dists, DistsSub, DistSig, isMC=True, log=True ):
    ...
    MakeEstPlots( EstMass, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputs/"+directory+method+"/Mass"+chan+"_"+scaleName, rhoBinBoundaries, True, isMC, False, log ) # Makes the actual estimation
