...
rootFiles = "/cms/gomez/archiveEOS/Archive/v8020/Analysis/v08/"

DATA = DIST( "DATA", rootFiles+"/RUNAnalysis_JetHT_Run2016_80X_V2p4_v08_cut15.root", "BoostedAnalysisPlotsPuppi/RUNATree", "1" )
...
for i in [ "QCDPt170to300", "QCDPt300to470", "QCDPt470to600", "QCDPt600to800", "QCDPt800to1000", "QCDPt1000to1400", "QCDPt1400to1800", "QCDPt1800to2400", "QCDPt2400to3200", "QCDPt3200toInf" ]:
    QCD.append( DIST( i, rootFiles+"/RUNAnalysis_"+i+"_80X_V2p4_v08.root", "BoostedAnalysisPlotsPuppi/RUNATree", ".85*puWeight*36555.21/15*"+str(scaleFactor(i)) ) )
QCDHT = DIST( "QCDHT", rootFiles+"/RUNAnalysis_QCDHTAll_80X_V2p4_v08.root", "BoostedAnalysisPlotsPuppi/RUNATree", ".85*puWeight*36555.21/15*lumiWeight")

TTJets = DIST( "TTJets", rootFiles+"/RUNAnalysis_TT_PtRewt_80X_V2p4_v08.root", "BoostedAnalysisPlotsPuppi/RUNATree", "("+weight+"*"+TTScaleStr+")" )
WJets = DIST( "WJets", rootFiles+"/RUNAnalysis_WJetsToQQ_80X_V2p4_v08.root", "BoostedAnalysisPlotsPuppi/RUNATree",  "("+weight+"*"+WScaleStr+")" )
Top = DIST( "Top", rootFiles+"/RUNAnalysis_ST_t-channel_topantitop_4f_inclusiveDecays_80X_V2p4_v08.root", "BoostedAnalysisPlotsPuppi/RUNATree",  "("+weight+"*"+TopScaleStr+")" )
...
def DDTMeasure(CUT,CHAN,NAME,TITLE,log):
    ...
    var_array = ["deltaEtaDijet", "prunedMassAsym", 50, 0., 5., 50, 0., 1.]
    Est.SetRegions( var_array, preselNOBT )
...
#    truthbins = []
    ...
    F = LinearFit([0.,0.,0.],0.,5.0,"linearfit", "SEMR")
    ...
    Est.TwoDPlot.GetXaxis().SetTitle("Delta Eta Dijet")
    ...
    Est.G.Draw("AP")
    Est.G.GetXaxis().SetTitle("Delta Eta Dijet")
    Est.G.GetXaxis().SetLimits(0.,5.)
...
#binsMass = [ [60,70], [70,80], [80,90], [90,100], [100,110], [110,120], [120,130], [130,140], [140,150], [150,160], [160,170], [170,180], [180,200], [200,220], [220,250], [250,300], [300,350] ]
#binsMass = [ [60,70], [70,80], [80,90], [90,100] ]
binsMass = [ ]
#i = 900
#while i < 950:
#    binsMass.append([i,i+10])
#    i = i+10
#i = 950
#while i < 1200:
#    binsMass.append([i,i+25])
#    i = i+25
#binsMass.append([3600,5000])
i = 50
while i < 350:
    binsMass.append([i,i+5])
    i=i+5
#binsMass = [[50,55],[55,60],[65,70]]
