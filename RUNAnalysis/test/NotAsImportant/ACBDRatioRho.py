...
def ABCDRatio():
    ...
    DATA_A = TH1D( "DATA_A", "", 10, -5.5, -3 )
    DATA_B = TH1D( "DATA_B", "", 10, -5.5, -3 )
    DATA_C = TH1D( "DATA_C", "", 10, -5.5, -3 )
    DATA_D = TH1D( "DATA_D", "", 10, -5.5, -3 )

    TTJETS_A = TH1D( "T_A", "", 10, -5.5, -3 )
    TTJETS_B = TH1D( "T_B", "", 10, -5.5, -3 )
    TTJETS_C = TH1D( "T_C", "", 10, -5.5, -3 )
    TTJETS_D = TH1D( "T_D", "", 10, -5.5, -3 )

    WJETS_A = TH1D( "W_A", "", 10, -5.5, -3 )
    WJETS_B = TH1D( "W_B", "", 10, -5.5, -3 )
    WJETS_C = TH1D( "W_C", "", 10, -5.5, -3 )
    WJETS_D = TH1D( "W_D", "", 10, -5.5, -3 )
    ...
    WJETS = DIST( "WJets0", "80XRootFilesUpdated/RUNAnalysis_WJetsToQQ_80X_V2p3_v06.root", "BoostedAnalysisPlots/RUNATree",  "("+weight+")" )
    ...
    for i in [ QCD170to300, QCD300to470, QCD470to600, QCD600to800, QCD800to1000, QCD1000to1400, QCD1400to1800, QCD1800to2400, QCD2400to3200, QCD3200toInf ]:
        quickplot( i.File, i.Tree, DATA_A, rho, PRES+"&"+A, i.weight)
        quickplot( i.File, i.Tree, DATA_B, rho, PRES+"&"+B, i.weight)
        quickplot( i.File, i.Tree, DATA_C, rho, PRES+"&"+C, i.weight)
        quickplot( i.File, i.Tree, DATA_D, rho, PRES+"&"+D, i.weight)
#    quickplot( DATA.File, DATA.Tree, DATA_A, rho, PRES+"&"+A , DATA.weight )
#    quickplot( DATA.File, DATA.Tree, DATA_B, rho, PRES+"&"+B , DATA.weight )
#    quickplot( DATA.File, DATA.Tree, DATA_C, rho, PRES+"&"+C , DATA.weight )
#    quickplot( DATA.File, DATA.Tree, DATA_D, rho, PRES+"&"+D , DATA.weight )
    quickplot( TTJETS.File, TTJETS.Tree, TTJETS_A, rho, PRES+"&"+A , TTJETS.weight )
    quickplot( TTJETS.File, TTJETS.Tree, TTJETS_B, rho, PRES+"&"+B , TTJETS.weight )
    quickplot( TTJETS.File, TTJETS.Tree, TTJETS_C, rho, PRES+"&"+C , TTJETS.weight )
    quickplot( TTJETS.File, TTJETS.Tree, TTJETS_D, rho, PRES+"&"+D , TTJETS.weight )
    quickplot( WJETS.File, WJETS.Tree, WJETS_A, rho, PRES+"&"+A , WJETS.weight )
    quickplot( WJETS.File, WJETS.Tree, WJETS_B, rho, PRES+"&"+B , WJETS.weight )
    quickplot( WJETS.File, WJETS.Tree, WJETS_C, rho, PRES+"&"+C , WJETS.weight )
    quickplot( WJETS.File, WJETS.Tree, WJETS_D, rho, PRES+"&"+D , WJETS.weight )
