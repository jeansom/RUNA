...
def ThetaFileMaker( chan, chanCuts, bins, minBin, maxBin, Xcut, Ycut, scaleTT, scaleTTErr, scaleW, scaleWErr, scaleAlpha, scaleAlphaErr, isMC=True ):
    gStyle.SetOptStat(0)
    ...
    TTJets = DIST( "TTJets", "RootFiles/RUNAnalysis_TTJets_RunIIFall15MiniAODv2_v76x_v2p0_v05.root", "BoostedAnalysisPlots/RUNATree", weight+"*((1.06 + .2*"+str(scaleTT)+" )*exp(-(0.0005 - 0.0001*"+str(scaleAlpha)+")*HT/2))" )
    TTJetsUp = DIST( "TTJetsUp", "RootFiles/RUNAnalysis_TTJets_RunIIFall15MiniAODv2_v76x_v2p0_v05.root", "BoostedAnalysisPlots/RUNATree", weight+"*((1.06 + 0.2*"+str(scaleTT)+" + 0.2*"+str(scaleTTErr)+")*exp(-(0.0005 - 0.0001*"+str(scaleAlpha)+")HT/2))" )
    TTJetsDn = DIST( "TTJetsDn", "RootFiles/RUNAnalysis_TTJets_RunIIFall15MiniAODv2_v76x_v2p0_v05.root", "BoostedAnalysisPlots/RUNATree", weight+"*((1.06 + 0.2*"+str(scaleTT)+" - 0.2*"+str(scaleTTErr)+")*exp(-(0.0005 - 0.0001*"+str(scaleAlpha)+")*HT/2))" )
    TTJetsAlphaUp = DIST( "TTJetsUp", "RootFiles/RUNAnalysis_TTJets_RunIIFall15MiniAODv2_v76x_v2p0_v05.root", "BoostedAnalysisPlots/RUNATree", weight+"*((1.06 + .2)*exp(-(0.0005 - .0001*" + str(scaleAlpha) + " - 0.0001*" + str(scaleAlphaErr) + ")*HT/2))" )
    TTJetsAlphaDn = DIST( "TTJetsDn", "RootFiles/RUNAnalysis_TTJets_RunIIFall15MiniAODv2_v76x_v2p0_v05.root", "BoostedAnalysisPlots/RUNATree",  weight+"*((1.06 + .2)*exp(-(0.0005 - .0001*" + str(scaleAlpha) + " + 0.0001*" + str(scaleAlphaErr) + ")*HT/2))" )
...
#    TTJetsDn = DIST( "TTJetsDn", "RootFiles/RUNAnalysis_TTJets_RunIIFall15MiniAODv2_v76x_v2p0_v05.root", "BoostedAnalysisPlots/RUNATree", weight+"*((1 - 0.5))" )
    ...
    WJets = DIST( "WJets", "RootFiles/RUNAnalysis_WJetsToQQ_RunIIFall15MiniAODv2_v76x_v2p0_v05.root", "BoostedAnalysisPlots/RUNATree", "("+weight+"*(1 + 0.5*"+str(scaleW)+"))" )
    WJetsUp = DIST( "WJetsUp", "RootFiles/RUNAnalysis_WJetsToQQ_RunIIFall15MiniAODv2_v76x_v2p0_v05.root", "BoostedAnalysisPlots/RUNATree", "("+weight+"*(1 + 0.5*"+str(scaleW)+" + 0.5*"+str(scaleWErr)+"))" )
    WJetsDn = DIST( "WJetsDn", "RootFiles/RUNAnalysis_WJetsToQQ_RunIIFall15MiniAODv2_v76x_v2p0_v05.root", "BoostedAnalysisPlots/RUNATree", "("+weight+"*(1 + 0.5*"+str(scaleW)+" - 0.5*"+str(scaleWErr)+"))" )
...
#    DistsSub = [ WJets, TTJets ]
    ...
    EstMassTTAlphaUp = Alphabet( "BkgEstMassTTAlphaUp", Dists, [WJets, TTJetsAlphaUp] )
    EstMassTTAlphaDn = Alphabet( "BkgEstMassTTAlphaDn", Dists, [WJets, TTJetsAlphaDn] )
...
#    print binsMass
    ...
    FMassTTAlphaUp = SigmoidFit([ 1.733,.7634,-3.516e-07,0,0 ],60,350,"Mass","SEMR")
    FMassTTAlphaDn = SigmoidFit([ 1.733,.7634,-3.516e-07,0,0 ],60,350,"Mass","SEMR")
...
#    elif "t2" in chan: chanCutsTemp = twoTop
    ...
    MakeFitPlots( EstMassTTAlphaUp, FMassTTAlphaUp, binsMass, "prunedMassAve", Xcut[0], var_arrayMass, presel+"&"+chanCutsTemp, Ycut[0]+">"+Ycut[1], cutsB, cutsD, cut, 0, "", "", "outputs/"+directory+method+"/MassTTAlphaUp"+chan, False )
    MakeEstPlots( EstMassTTAlphaUp, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputs/"+directory+method+"/MassTTAlphaUp"+chan, False )

    MakeFitPlots( EstMassTTAlphaDn, FMassTTAlphaDn, binsMass, "prunedMassAve", Xcut[0], var_arrayMass, presel+"&"+chanCutsTemp, Ycut[0]+">"+Ycut[1], cutsB, cutsD, cut, 0, "", "", "outputs/"+directory+method+"/MassTTAlphaDn"+chan, False )
    MakeEstPlots( EstMassTTAlphaDn, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputs/"+directory+method+"/MassTTAlphaDn"+chan, False )
    ...
    quickplot( TTJetsAlphaUp.File, TTJetsAlphaUp.Tree, chan__TTBAR__TTAlphaScale__up, "prunedMassAve", presel+"&"+cuts+"&"+chanCuts, TTJetsAlphaUp.weight )
    quickplot( TTJetsAlphaDn.File, TTJetsAlphaDn.Tree, chan__TTBAR__TTAlphaScale__down, "prunedMassAve", presel+"&"+cuts+"&"+chanCuts, TTJetsAlphaDn.weight )
    ...
    C.SaveAs("outputs/"+directory+method+"/"+chan+"__TTBAR__TTAlphaScale__up.png")
    chan__TTBAR__TTAlphaScale__down.Draw("hist")
    C.SaveAs("outputs/"+directory+method+"/"+chan+"__TTBAR__TTAlphaScale__down.png")
    chan__QCD__TTAlphaScale__up.Draw("hist")
    C.SaveAs("outputs/"+directory+method+"/"+chan+"__QCD__TTAlphaScale__up.png")
    chan__QCD__TTAlphaScale__down.Draw("hist")
    C.SaveAs("outputs/"+directory+method+"/"+chan+"__QCD__TTAlphaScale__down.png")
...
scaleTTAlphaErr = 1
if int(channel) == 0:
    ThetaFileMaker( "b0t0", zerobtag+"&"+zeroTop, 29, 60, 350, Xcut, Ycut, scaleTT, scaleTTErr, scaleW, scaleWErr, scaleTTAlpha, scaleTTAlphaErr, isMC )
if int(channel) == 1:
    ThetaFileMaker( "b1t0", onebtag+"&"+zeroTop, 29, 60, 350, Xcut, Ycut, scaleTT, scaleTTErr, scaleW, scaleWErr, scaleTTAlpha, scaleTTAlphaErr, isMC )
if int(channel) == 2:
    ThetaFileMaker( "b2t0", twobtag+"&"+zeroTop, 29, 60, 350, Xcut, Ycut, scaleTT, scaleTTErr, scaleW, scaleWErr, scaleTTAlpha, scaleTTAlphaErr, isMC )
if int(channel) == 3:
    ThetaFileMaker( "b0t1", zerobtag+"&"+oneTop, 29, 60, 350, Xcut, Ycut, scaleTT, scaleTTErr, scaleW, scaleWErr, scaleTTAlpha, scaleTTAlphaErr, isMC )
if int(channel) == 4:
    ThetaFileMaker( "b1t1", onebtag+"&"+oneTop, 29, 60, 350, Xcut, Ycut, scaleTT, scaleTTErr, scaleW, scaleWErr, scaleTTAlpha, scaleTTAlphaErr, isMC )
#    ThetaFileMaker( "b1t1", "( ("+jet1Top+"&"+jet2btag+")||("+jet2Top+"&"+jet1btag+") )", 29, 60, 350, Xcut, Ycut, isMC )
if int(channel) == 5:
    ThetaFileMaker( "b2t1", twobtag+"&"+oneTop, 29, 60, 350, Xcut, Ycut, scaleTT, scaleTTErr, scaleW, scaleWErr, scaleTTAlpha, scaleTTAlphaErr, isMC )
if int(channel) == 6:
    ThetaFileMaker( "b0t2", zerobtag+"&"+twoTop, 29, 60, 350, Xcut, Ycut, scaleTT, scaleTTErr, scaleW, scaleWErr, scaleTTAlpha, scaleTTAlphaErr, isMC )
if int(channel) == 7:
    ThetaFileMaker( "b1t2", onebtag+"&"+twoTop, 29, 60, 350, Xcut, Ycut, scaleTT, scaleTTErr, scaleW, scaleWErr, scaleTTAlpha, scaleTTAlphaErr, isMC )
if int(channel) == 8:
    ThetaFileMaker( "b2t2", twobtag+"&"+twoTop, 29, 60, 350, Xcut, Ycut, scaleTT, scaleTTErr, scaleW, scaleWErr, scaleTTAlpha, scaleTTAlphaErr, isMC )
if int(channel) == -1:
    ThetaFileMaker( "b2t2", "(abs(jet1CSVv2)>-1)", 29, 60, 350, Xcut, Ycut, scaleTT, scaleTTErr, scaleW, scaleWErr, scaleTTAlpha, scaleTTAlphaErr, isMC )
