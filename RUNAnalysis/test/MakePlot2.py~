...
def MakePlot(VAR, BINS, CUT, NAME, Title, cutName):
	...
	quickplot("80XRootFiles/RUNAnalysis_QCDPtAll_Moriond17_80X_V2p4_v05.root", "BoostedAnalysisPlots/RUNATree", PlotsQCD, VAR, CUT, "lumiWeight*puWeight*36600")
	quickplot("80XRootFiles/RUNBoostedAnalysis_RPVStopStopToJets_UDD323_M-100v01.root", "BoostedAnalysisPlots/RUNATree", PlotsSig323, VAR, CUT, "puWeight*36600*1521.11/259991")
#	quickplot("80XRootFiles/RUNBoostedAnalysis_RPVStopStopToJets_UDD323_M-100v01.root", "BoostedAnalysisPlots/RUNATree", PlotsSig323, VAR, CUT, "1")
	quickplot("80XRootFiles/RPVStopUDD312.root", "BoostedAnalysisPlots/RUNATree", PlotsSig312, VAR, CUT, "puWeight*36600*lumiWeight")
	print PlotsSig323.Integral(0,10000)
	#quickplot("80XRootFiles/RUNBoostedAnalysis_RPVStopStopToJets_UDD312_M-100v01.root", "BoostedAnalysisPlots/RUNATree", PlotsSig312, VAR, CUT, "lumiWeight*puWeight*36600")
	quickplot("80XRootFiles/RUNAnalysis_TT_TuneCUETP8M2T4_Moriond17_80X_V2p4_v05.root", "BoostedAnalysisPlots/RUNATree", PlotsTT, VAR, CUT, "lumiWeight*puWeight*36600")
	quickplot("80XRootFiles/RUNAnalysis_WJetsToQQ_Moriond17_80X_V2p4_v05.root", "BoostedAnalysisPlots/RUNATree", PlotsWJets, VAR, CUT, "lumiWeight*puWeight*36600")
	quickplot("80XRootFiles/RUNBoostedAnalysis_ZJetsToQQ_HT600toInf_13TeV-madgraphv01.root", "BoostedAnalysisPlots/RUNATree", PlotsZJets, VAR, CUT, "lumiWeight*puWeight*36600")
	quickplot("80XRootFiles/RUNBoostedAnalysis_WWTo4Q_13TeV-powhegv01.root", "BoostedAnalysisPlots/RUNATree", PlotsWW, VAR, CUT, "lumiWeight*puWeight*36600")
	quickplot("80XRootFiles/RUNBoostedAnalysis_ZZTo4Q_13TeV_amcatnloFXFX_madspin_pythia8v01.root", "BoostedAnalysisPlots/RUNATree", PlotsZZ, VAR, CUT, "lumiWeight*puWeight*36600")
	#quickplot("80XRootFiles/RUNBoostedAnalysis_WZv01.root", "BoostedAnalysisPlots/RUNATree", PlotsWZ, VAR, CUT, "lumiWeight*puWeight")
...
#	SOverSqrtBUDD312.Draw("histe")
	...
	SOverSqrtBUDD323.GetYaxis().SetTitle("S/#sqrt{B}")
...
MakePlot( "prunedMassAve", [ 12, 50, 350 ], "(jet1btagCMVAv2>0.4432&jet2btagCMVAv2>0.4432)&(prunedMassAsym<0.1)&(deltaEtaDijet<1.0)&(jet1Tau32>0.51&jet2Tau32>0.51)&jet1Tau21<0.60&jet2Tau21<0.60", "prunedMassAveCMVAv2MA", "prunedMassAve", "Average Pruned Mass [GeV]" )
MakePlot( "prunedMassAve", [ 12, 50, 350 ], "(jet1btagCMVAv2>0.4432&jet2btagCMVAv2>0.4432)&(prunedMassAsym<0.1)&(deltaEtaDijet>1.0)&(jet1Tau32>0.51&jet2Tau32>0.51)&jet1Tau21<0.60&jet2Tau21<0.60", "prunedMassAveCMVAv2MB", "prunedMassAve", "Average Pruned Mass [GeV]" )
MakePlot( "prunedMassAve", [ 12, 50, 350 ], "(jet1btagCMVAv2>0.4432&jet2btagCMVAv2>0.4432)&(prunedMassAsym>0.1)&(deltaEtaDijet<1.0)&(jet1Tau32>0.51&jet2Tau32>0.51)&jet1Tau21<0.60&jet2Tau21<0.60", "prunedMassAveCMVAv2MC", "prunedMassAve", "Average Pruned Mass [GeV]" )
MakePlot( "prunedMassAve", [ 12, 50, 350 ], "(jet1btagCMVAv2>0.4432&jet2btagCMVAv2>0.4432)&(prunedMassAsym>0.1)&(deltaEtaDijet>1.0)&(jet1Tau32>0.51&jet2Tau32>0.51)&jet1Tau21<0.60&jet2Tau21<0.60", "prunedMassAveCMVAv2MD", "prunedMassAve", "Average Pruned Mass [GeV]" )
...
MakePlot( "HT", [ 250, 0, 5000 ], "jet2btagCSVv2>-9999", "HT", "HT", "HT" )
