...
#	quickplot("80XRootFiles/RUNBoostedAnalysis_QCD_PtAllv03.root", "BoostedAnalysisPlots/RUNATree", PlotsQCD, VAR, CUT, "lumiWeight*"+MCScale+"*1000.*.77")
	quickplot("80XRootFiles/RUNAnalysis_QCDPtAll_Moriond17_80X_V2p4_v05.root", "BoostedAnalysisPlots/RUNATree", PlotsQCD, VAR, CUT, "lumiWeight*"+MCScale+"*.77")
	quickplot("80XRootFiles/RUNBoostedAnalysis_RPVStopStopToJets_UDD323_M-100v01.root", "BoostedAnalysisPlots/RUNATree", PlotsSig323, VAR, CUT, "puWeight*"+MCScale+"*1521.11/259991")
#	quickplot("80XRootFiles/RUNBoostedAnalysis_RPVStopStopToJets_UDD323_M-100v01.root", "BoostedAnalysisPlots/RUNATree", PlotsSig323, VAR, CUT, "1")
	quickplot("80XRootFiles/RPVStopUDD312.root", "BoostedAnalysisPlots/RUNATree", PlotsSig312, VAR, CUT, "puWeight*"+MCScale+"*lumiWeight")
	print PlotsSig323.Integral(0,10000)
	#quickplot("80XRootFiles/RUNBoostedAnalysis_RPVStopStopToJets_UDD312_M-100v01.root", "BoostedAnalysisPlots/RUNATree", PlotsSig312, VAR, CUT, "lumiWeight*"+MCScale)
	quickplot("80XRootFiles/RUNBoostedAnalysis_TT_TuneCUETP8M2T4_13TeV-powheg-pythia8v04.root", "BoostedAnalysisPlots/RUNATree", PlotsTT, VAR, CUT, "lumiWeight*"+MCScale)
#	quickplot("80XRootFiles/RUNBoostedAnalysis_TT_TuneCUETP8M2T4_13TeV-powheg-pythia8v04.root", "BoostedAnalysisPlots/RUNATree", PlotsTT, VAR, CUT, "1")
	quickplot("80XRootFiles/RUNBoostedAnalysis_WJetsToQQ_HT-600ToInfv04.root", "BoostedAnalysisPlots/RUNATree", PlotsWJets, VAR, CUT, "lumiWeight*"+MCScale)
	quickplot("80XRootFiles/RUNBoostedAnalysis_ZJetsToQQ_HT600toInf_13TeV-madgraphv01.root", "BoostedAnalysisPlots/RUNATree", PlotsZJets, VAR, CUT, "lumiWeight*"+MCScale)
	quickplot("80XRootFiles/RUNBoostedAnalysis_WWTo4Q_13TeV-powhegv01.root", "BoostedAnalysisPlots/RUNATree", PlotsWW, VAR, CUT, "lumiWeight*"+MCScale)
	quickplot("80XRootFiles/RUNBoostedAnalysis_ZZTo4Q_13TeV_amcatnloFXFX_madspin_pythia8v01.root", "BoostedAnalysisPlots/RUNATree", PlotsZZ, VAR, CUT, "lumiWeight*"+MCScale)
	#quickplot("80XRootFiles/RUNBoostedAnalysis_WZv01.root", "BoostedAnalysisPlots/RUNATree", PlotsWZ, VAR, CUT, "lumiWeight")

	quickplot("80XRootFiles/RUNAnalysis_JetHT_Run2016_80X_V2p4_v05_cut.root", "BoostedAnalysisPlots/RUNATree", PlotsDATA, VAR, CUT, "1")
...
#	stackPlots.GetXaxis().SetTitle(cutName)
	stackPlots.GetYaxis().SetRangeUser(0,500e03)
	stackPlots.SetMaximum(500e03)
...
#MakePlot( "prunedMassAve", [ 40, 0, 400 ], "(abs(jet1Pt)>-999)", "prunedMassAve", "prunedMassAve", "Average Pruned Mass [GeV]" )
#MakePlot( "prunedMassAsym", [ 20, 0, 1 ], "(abs(jet1Pt)>-999)", "prunedMassAsym_NoPU", "prunedMassAsym", "Pruned Mass Asymmetry" )
#MakePlot( "jet1Tau21", [ 20, 0, 1 ], "(abs(jet1Pt)>-999)", "jet1Tau21_NoPU", "jet1Tau21", "Leading Jet Tau21" )
#MakePlot( "jet2Tau21", [ 20, 0, 1 ], "(abs(jet1Pt)>-999)", "jet2Tau21_NoPU", "jet2Tau21", "2nd Leading Jet Tau21" )
#MakePlot( "deltaEtaDijet", [ 20, 0, 5 ], "(abs(jet1Pt)>-999)", "deltaEtaDijet_NoPU", "deltaEtaDijet", "Delta Eta Dijet" )
#MakePlot( "jet1Pt", [ 60, 400, 600 ], "(abs(jet1Pt)>-999)", "jet1Pt_NoPU", "jet1Pt", "Leading Jet Pt" )
#MakePlot( "jet2Pt", [ 60, 400, 600 ], "(abs(jet2Pt)>-999)", "jet2Pt_NoPU", "jet2Pt", "2nd Leading Jet Pt" )
MakePlot( "numPV", [ 30, 0, 30 ], "(abs(jet1Pt)>-999)", "NPV_NoPU", "numPV", "numPV" )
#MakePlot( "HT", [ 130, 700, 2000 ], "(abs(jet1Pt)>-999)", "HT_NoPU", "HT", "HT" )
#MakePlot( "prunedMassAsym", [ 20, 0, 1 ], "(jet1Tau21<0.45&jet2Tau21<0.45&deltaEtaDijet<1.5)", "prunedMassAsym_n-1_noPU", "prunedMassAsym", "Pruned Mass Asymmetry n-1" )
#MakePlot( "jet1Tau21", [ 20, 0, 1 ], "(prunedMassAsym<0.1&deltaEtaDijet<1.5)", "jet1Tau21_n-1_noPU", "jet1Tau21", "Leading Jet Tau21 n-1" )
#MakePlot( "jet2Tau21", [ 20, 0, 1 ], "(prunedMassAsym<0.1&deltaEtaDijet<1.5)", "jet2Tau21_n-1_noPU", "jet2Tau21", "2nd Leading Jet Tau21 n-1" )
#MakePlot( "deltaEtaDijet", [ 20, 0, 5 ], "(prunedMassAsym<0.1&jet1Tau21<0.45&jet2Tau21<0.45)", "deltaEtaDijet_n-1_noPU", "deltaEtaDijet", "Delta Eta Dijet n-1" )
