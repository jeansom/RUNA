...
def RunEst(F, NAME, NAMEF, masses, deta, useFile):
    ...
    for bin in xrange(1, DATA.GetNbinsX()+1): DATA.SetBinContent(bin, DATA.GetBinContent(bin))
    DATA.Sumw2()
    if len(DATASUB)==3:
...
DATA = DIST( "DATA", "v08/RUNAnalysis_JetHT_Run2016_80X_V2p4_v08_cut15.root", "BoostedAnalysisPlotsPuppi/RUNATree", "1" )
...
#Fatan.SetParameters(0.4,0.1,0.,150.)
