...
if [ $1 -eq 0 ];
then
    python TreeMaker.py -o "80XRootFiles/RUNAnalysis_JetHT_Run2016D_80X_V2p4_v05.root" -n "80XRootFiles/RUNAnalysis_JetHT_Run2016D_80X_V2p4_v05_cut_2.root" -d "BoostedAnalysisPlots" -t "RUNATree"
elif [ $1 -eq 1 ];
then
