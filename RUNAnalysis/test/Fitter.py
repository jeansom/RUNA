...
def Fitter( inFileBkg, inFileSignal, hist, folder, fitFunction, minX, maxX ):
	...
	#fitFunction.SetParameter(1, hBkg.GetMaximumBin()*binSize)
	#fitFunction.SetParameter(2,-60.)
	#fitFunction.SetParameter(1,1000)
	fitFunction.SetParameter(0,1)
	hBkg.Fit(fitFunction,"","",minX,maxX)
	hBkg.Fit(fitFunction,"","",minX,maxX)
	hBkg.Fit(fitFunction,"","",minX,maxX)
...
if __name__ == '__main__':
	...
	outputDir = "Plots/"
	inFileBkg = TFile('Rootfiles/RUNAnalysis_QCDPtAll_RunIISpring15DR74_'+PU+'_v01_v03.root')
	inFileSignal = TFile('Rootfiles/RUNAnalysis_RPVSt'+str(MASS)+'tojj_RunIISpring15DR74_'+PU+'_v02_v03.root')
	inFileData = TFile('Rootfiles/RUNAnalysis_QCDPtAll_RunIISpring15DR74_'+PU+'_v01_v03.root')
	...
	if 'simple' in process:
		...
		rooFitter( inFileBkg, inFileSignal, hist, folder, MASS, outputRootFile, 80.0, 250.0  )
