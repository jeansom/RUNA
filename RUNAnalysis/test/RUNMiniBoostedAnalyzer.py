...
def myAnalyzer( dictSamples, listCuts, signalName, RANGE, UNC ):
	...
	outputFileName = 'Rootfiles/102116Tau32Inverse/RUNMiniBoostedAnalysis_'+grooming+'_'+signalName+UNC+'_'+RANGE+'_'+args.version+'p6.root' 
	...
	for sample in dictSamples:
		...
		for i in xrange(numEntries):
			...
			subjet11BtagCSV		= ( events.subjet11btagCSVv2 > 0.800 )
			subjet12BtagCSV		= ( events.subjet12btagCSVv2 > 0.800 )
			subjet21BtagCSV		= ( events.subjet21btagCSVv2 > 0.800 )
			subjet22BtagCSV		= ( events.subjet22btagCSVv2 > 0.800 )
...
#				bothBtag = ( jet1BtagCSV and jet2BtagCSV )
				oneBtag = ( ( subjet11BtagCSV or subjet12BtagCSV ) and ( subjet21BtagCSV or subjet22BtagCSV ) ) 
...
#	try: cuts = [ [ 'jet1Tau21', 0.45 ], [ 'jet2Tau21', 0.45 ], [ 'prunedMassAsym', 0.10 ], [ 'deltaEtaDijet', 1.5 ] ]
	try: cuts = [ [ 'jet1Tau21', 0.6 ], [ 'jet2Tau21', 0.6 ], [ 'prunedMassAsym', 0.10 ], [ 'deltaEtaDijet', 1.0 ], [ 'jet1Tau32', 0.51 ], [ 'jet2Tau32', 0.51 ] ]
	except KeyError: 
