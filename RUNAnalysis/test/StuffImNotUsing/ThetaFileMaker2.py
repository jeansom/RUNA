...
#    chanCutsTemp = chanCuts
    ...
    MakeFitPlots( EstMass, FMass, binsMass, "prunedMassAve", Xcut[0], var_arrayMass, presel+"&"+chanCutsTemp, Ycut[0]+">"+Ycut[1], cutsB, cutsD, cut, 0, "", "", "outputsMC/Mass"+chan, False )
    MakeEstPlots( EstMass, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputsMC/Mass"+chan,  False )

    MakeFitPlots( EstMassWJUp, FMassWJUp, binsMass, "prunedMassAve", Xcut[0], var_arrayMass, presel+"&"+chanCutsTemp, Ycut[0]+">"+Ycut[1], cutsB, cutsD, cut, 0, "", "",  "outputsMC/MassWJUp"+chan, False )
    MakeEstPlots( EstMassWJUp, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputsMC/MassWJUp"+chan, False )

    MakeFitPlots( EstMassWJDn, FMassWJDn, binsMass, "prunedMassAve", Xcut[0], var_arrayMass, presel+"&"+chanCutsTemp, Ycut[0]+">"+Ycut[1], cutsB, cutsD, cut, 0, "", "", "outputsMC/MassWJDn"+chan, False )
    MakeEstPlots( EstMassWJDn, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputsMC/MassWJDn"+chan, False )

    MakeFitPlots( EstMassTTUp, FMassTTUp, binsMass, "prunedMassAve", Xcut[0], var_arrayMass, presel+"&"+chanCutsTemp, Ycut[0]+">"+Ycut[1], cutsB, cutsD, cut, 0, "", "", "outputsMC/MassTTUp"+chan, False )
    MakeEstPlots( EstMassTTUp, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputsMC/MassTTUp"+chan, False )

    MakeFitPlots( EstMassTTDn, FMassTTDn, binsMass, "prunedMassAve", Xcut[0], var_arrayMass, presel+"&"+chanCutsTemp, Ycut[0]+">"+Ycut[1], cutsB, cutsD, cut, 0, "", "", "outputsMC/MassTTDn"+chan, False )
    MakeEstPlots( EstMassTTDn, "prunedMassAve", "Average Mass", binBoundaries, presel+"&"+chanCuts+"&"+anticuts, presel+"&"+chanCuts+"&"+cuts, "prunedMassAve", "", "outputsMC/MassTTDn"+chan, False )

    # Makes root file with basic fits
    FITFILE = TFile( "outputsMC/LIM_FIT"+chan+".root", "RECREATE" )
    FITFILE.cd()
    ...
    FILE = TFile( "outputsMC/LIM_FEED"+chan+".root", "RECREATE" )
    FILE.cd()
    #### Write plots to file    
    chan__DATA.Write()
    chan__QCD.Write()
    ...
    C.SaveAs("outputsMC/"+chan+"__DATA.png")
    chan__QCD.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__QCD.png")
    chan__TTBAR.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__TTBAR.png")
    chan__WJETS.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__WJets.png")
    chan__QCD__Fit__up.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__QCD__Fit__up.png")
    chan__QCD__Fit__down.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__QCD__Fit__down.png")
    chan__TTBAR__TTScale__up.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__TTBAR__TTScale__up.png")
    chan__TTBAR__TTScale__down.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__TTBAR__TTScale__down.png")
    chan__QCD__TTScale__up.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__QCD__TTScale__up.png")
    chan__QCD__TTScale__down.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__QCD__TTScale__down.png")
    chan__WJETS__WJScale__up.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__WJETS__WJScale__up.png")
    chan__WJETS__WJScale__down.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__WJETS__WJScale__down.png")
    chan__QCD__WJScale__up.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__QCD__WJScale__up.png")
    chan__QCD__WJScale__down.Draw("hist")
    C.SaveAs("outputsMC/"+chan+"__QCD__WJScale__down.png")
