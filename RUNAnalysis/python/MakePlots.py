...
def makePlots( nameInRoot, tmphisto1, labelh1, tmphisto2, labelh2, binWidth, xmin, xmax, ratio, labelRatio, ratio2, typePlot, binning, version, grooming, plotFolder, log=False, reScale=False, addUncBand=True):
	...
	histo1.GetYaxis().SetTitle('Events / '+(str(int(binWidth)) + ' GeV'))
	...
	outputFileName = nameInRoot+'_'+typePlot+'_'+str(grooming)+'_QCDPt_bkgShapeEstimationBoostedPlots'+str(version)+'.png'
