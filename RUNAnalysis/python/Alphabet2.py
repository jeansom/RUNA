...
#        self.Fit.ConvFact = "1/(1.829+exp(0.3742-3.046e-07*prunedMassAve*prunedMassAve*prunedMassAve))"
        ...
        for i in self.DP:
            ...
            print variable
            print antitag
            print "("+i.weight+"*("+self.Fit.ConvFact+"))"

            quickplot( i.File, i.Tree, temphistN, variable, antitag, "("+i.weight+"*("+self.Fit.ConvFact+"))" )
#            quickplot("RootFiles/RUNAnalysis_JetHT_Run2015D-16Dec2015-v1_v76x_v2p0_v05.root", "BoostedAnalysisPlots/RUNATree", temphistN, "prunedMassAve",  "(jet1Tau21<0.45&jet2Tau21<0.45&deltaEtaDijet<1.5&prunedMassAsym>0.1)", "1/(1.829+exp(0.3742-3.046e-07*prunedMassAve*prunedMassAve*prunedMassAve))" )
            for bin in xrange(temphistN.GetNbinsX()):
                print temphistN.GetBinContent(bin)
        ...
        for i in self.DM:
            ...
            for bin in xrange(temphistN.GetNbinsX()):
                print temphistN.GetBinContent(bin)
            print "--------------------------------------"
            for bin in xrange(temphist.GetNbinsX()):
                print temphist.GetBinContent(bin)
