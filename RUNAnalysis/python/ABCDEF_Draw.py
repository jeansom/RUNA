...
# Draws and saves estimate
### StackEst: Estimate as a stack plot
### EST: QCD Est
### DATA: Signal region plot
### Boxes: Errors on est as TBox
### pBoxes: Errors on pull as TBox
### sBoxes: Syst errors as TBox
### Pull: Data MC ratio plot
### Pull2: Pull plot
### NAME: Name for saving
### NAMEF: Doesn't matter, ignore
...
# Compares est using old method to est using new method
...
### Compares fit using old method to fit using new method
