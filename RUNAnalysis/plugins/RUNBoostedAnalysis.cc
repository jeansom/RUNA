...
class RUNBoostedAnalysis : public EDAnalyzer {
   ...
   private:
      ...
      //ULong64_t event = 0;
      int numJets = 0, numPV = 0, lumi = 0, run=0, event = 0;
      float HT = 0, trimmedMass = -999, 
      ...
      EDGetTokenT<int> lumi_;
      EDGetTokenT<int> run_;
      EDGetTokenT<int> event_;
...
//	triggerBits_(consumes<TriggerResults>(iConfig.getParameter<InputTag>("bits"))),
	...
	lumi_(consumes<int>(iConfig.getParameter<InputTag>("Lumi"))),
	run_(consumes<int>(iConfig.getParameter<InputTag>("Run"))),
	event_(consumes<int>(iConfig.getParameter<InputTag>("Event"))),
	//Jet ID,
...
void RUNBoostedAnalysis::analyze(const Event& iEvent, const EventSetup& iSetup) {
	...
	*/
	...
	Handle<int> Event;
	iEvent.getByToken(event_, Event);
	...
	if ( numJets > 1 ) {
		...
		if ( mkTree ) {
			...
			if( cutMass && cutHT ){
				...
				histos1D_[ "jetPt_cutTrigger" ]->Fill( (*jetPt)[0], scale  );
				histos1D_[ "jetPt_cutTrigger" ]->Fill( (*jetPt)[1], scale  );
				histos1D_[ "jetEta_cutTrigger" ]->Fill( (*jetEta)[0], scale  );
				histos1D_[ "jetEta_cutTrigger" ]->Fill( (*jetEta)[1], scale  );
				histos1D_[ "jetMass_cutTrigger_Ptsort" ]->Fill( (*jetMass)[0], scale );
				histos1D_[ "jetMass_cutTrigger" ]->Fill( JETS[0].mass, scale );

				histos1D_[ "massAsymmetry_cutTrigger" ]->Fill( massAsym, scale  );
				histos1D_[ "massAve_cutTrigger" ]->Fill( massAve, scale  );
				if( numPV < 25 )  histos1D_[ "massAveLowPU_cutTrigger" ]->Fill( massAve, scale  );
				else if( ( numPV > 25 ) && ( numPV < 35 ) )  histos1D_[ "massAveMedPU_cutTrigger" ]->Fill( massAve, scale  );
				else  histos1D_[ "massAveHighPU_cutTrigger" ]->Fill( massAve, scale  );
				histos2D_[ "massAvevsJet1Mass_cutTrigger" ]->Fill( massAve, jet1Mass, scale );
				histos2D_[ "massAvevsJet2Mass_cutTrigger" ]->Fill( massAve, jet2Mass, scale );
				histos2D_[ "jet1vs2Mass_cutTrigger" ]->Fill( jet1Mass, jet2Mass, scale );

				histos1D_[ "cosThetaStar_cutTrigger" ]->Fill( cosThetaStar, scale  );
				histos1D_[ "jet1Tau1_cutTrigger" ]->Fill( JETS[0].tau1, scale );
				histos1D_[ "jet1Tau2_cutTrigger" ]->Fill( JETS[0].tau2, scale );
				histos1D_[ "jet1Tau3_cutTrigger" ]->Fill( JETS[0].tau3, scale );
				histos1D_[ "jet1Tau21_cutTrigger" ]->Fill( jet1Tau21, scale );
				histos1D_[ "jet1Tau31_cutTrigger" ]->Fill( jet1Tau31, scale );
				histos1D_[ "jet1Tau32_cutTrigger" ]->Fill( jet1Tau32, scale );
				histos2D_[ "dijetCorr_cutTrigger" ]->Fill( JETS[0].p4.Eta(), JETS[1].p4.Eta(), scale );
				histos2D_[ "dijetCorrPhi_cutTrigger" ]->Fill( JETS[0].p4.Phi(), JETS[1].p4.Phi(), scale );

				histos1D_[ "jet1Subjet1Pt_cutTrigger" ]->Fill( jet1SubjetsTLV[0].Pt(), scale );
				histos1D_[ "jet1Subjet2Pt_cutTrigger" ]->Fill( jet1SubjetsTLV[1].Pt(), scale );
				histos1D_[ "jet1SubjetPtRatio_cutTrigger" ]->Fill( jet1SubjetPtRatio, scale );
				histos1D_[ "jet1Subjet1Mass_cutTrigger" ]->Fill( jet1SubjetsTLV[0].M(), scale );
				histos1D_[ "jet1Subjet2Mass_cutTrigger" ]->Fill( jet1SubjetsTLV[1].M(), scale );
				histos1D_[ "jet1SubjetMass21Ratio_cutTrigger" ]->Fill( jet1SubjetMass21Ratio, scale );
				histos1D_[ "jet1Subjet112MassRatio_cutTrigger" ]->Fill( jet1Subjet112MassRatio, scale );
				histos1D_[ "jet1Subjet1JetMassRatio_cutTrigger" ]->Fill( jet1Subjet1JetMassRatio, scale );
				histos1D_[ "jet1Subjet212MassRatio_cutTrigger" ]->Fill( jet1Subjet212MassRatio, scale );
				histos1D_[ "jet1Subjet2JetMassRatio_cutTrigger" ]->Fill( jet1Subjet2JetMassRatio, scale );
				histos2D_[ "jet1Subjet12Mass_cutTrigger" ]->Fill( jet1SubjetsTLV[0].M(), jet1SubjetsTLV[1].M(), scale );
				histos2D_[ "jet1Subjet112vs212MassRatio_cutTrigger" ]->Fill( jet1Subjet112MassRatio, jet1Subjet212MassRatio, scale );
				histos2D_[ "jet1Subjet1JetvsSubjet2JetMassRatio_cutTrigger" ]->Fill( jet1Subjet1JetMassRatio, jet1Subjet2JetMassRatio, scale );

				histos1D_[ "jet2Subjet1Pt_cutTrigger" ]->Fill( jet2SubjetsTLV[0].Pt(), scale );
				histos1D_[ "jet2Subjet2Pt_cutTrigger" ]->Fill( jet2SubjetsTLV[1].Pt(), scale );
				histos1D_[ "jet2SubjetPtRatio_cutTrigger" ]->Fill( jet2SubjetPtRatio, scale );
				histos1D_[ "jet2Subjet1Mass_cutTrigger" ]->Fill( jet2SubjetsTLV[0].M(), scale );
				histos1D_[ "jet2Subjet2Mass_cutTrigger" ]->Fill( jet2SubjetsTLV[1].M(), scale );
				histos1D_[ "jet2SubjetMass21Ratio_cutTrigger" ]->Fill( jet2SubjetMass21Ratio, scale );
				histos1D_[ "jet2Subjet112MassRatio_cutTrigger" ]->Fill( jet2Subjet112MassRatio, scale );
				histos1D_[ "jet2Subjet1JetMassRatio_cutTrigger" ]->Fill( jet2Subjet1JetMassRatio, scale );
				histos1D_[ "jet2Subjet212MassRatio_cutTrigger" ]->Fill( jet2Subjet212MassRatio, scale );
				histos1D_[ "jet2Subjet2JetMassRatio_cutTrigger" ]->Fill( jet2Subjet2JetMassRatio, scale );
				histos2D_[ "jet2Subjet12Mass_cutTrigger" ]->Fill( jet2SubjetsTLV[0].M(), jet2SubjetsTLV[1].M(), scale );
				histos2D_[ "jet2Subjet112vs212MassRatio_cutTrigger" ]->Fill( jet2Subjet112MassRatio, jet2Subjet212MassRatio, scale );
				histos2D_[ "jet2Subjet1JetvsSubjet2JetMassRatio_cutTrigger" ]->Fill( jet2Subjet1JetMassRatio, jet2Subjet2JetMassRatio, scale );

				histos1D_[ "subjetPtRatio_cutTrigger" ]->Fill( jet1SubjetPtRatio, scale );
				histos1D_[ "subjetPtRatio_cutTrigger" ]->Fill( jet2SubjetPtRatio, scale );
				histos1D_[ "subjetMass21Ratio_cutTrigger" ]->Fill( jet1SubjetMass21Ratio, scale );
				histos1D_[ "subjetMass21Ratio_cutTrigger" ]->Fill( jet2SubjetMass21Ratio, scale );
				histos1D_[ "subjet112MassRatio_cutTrigger" ]->Fill( jet1Subjet112MassRatio, scale );
				histos1D_[ "subjet112MassRatio_cutTrigger" ]->Fill( jet2Subjet112MassRatio, scale );
				histos1D_[ "subjet212MassRatio_cutTrigger" ]->Fill( jet1Subjet212MassRatio, scale );
				histos1D_[ "subjet212MassRatio_cutTrigger" ]->Fill( jet2Subjet212MassRatio, scale );
				histos2D_[ "subjet12Mass_cutTrigger" ]->Fill( jet1SubjetsTLV[0].M(), jet1SubjetsTLV[1].M(), scale );
				histos2D_[ "subjet12Mass_cutTrigger" ]->Fill( jet2SubjetsTLV[0].M(), jet2SubjetsTLV[1].M(), scale );
				histos2D_[ "subjet112vs212MassRatio_cutTrigger" ]->Fill( jet1Subjet112MassRatio, jet1Subjet212MassRatio, scale );
				histos2D_[ "subjet112vs212MassRatio_cutTrigger" ]->Fill( jet2Subjet112MassRatio, jet2Subjet212MassRatio, scale );
				histos2D_[ "subjet1JetvsSubjet2JetMassRatio_cutTrigger" ]->Fill( jet1Subjet1JetMassRatio, jet1Subjet2JetMassRatio, scale );
				histos2D_[ "subjet1JetvsSubjet2JetMassRatio_cutTrigger" ]->Fill( jet2Subjet1JetMassRatio, jet2Subjet2JetMassRatio, scale );

				histos1D_[ "subjetPolAngle13412_cutTrigger" ]->Fill( cosPhi13412, scale );
				histos2D_[ "subjetPolAngle13412vsSubjetPtRatio_cutTrigger" ]->Fill( cosPhi13412, jet1SubjetPtRatio, scale );
				histos1D_[ "subjetPolAngle31234_cutTrigger" ]->Fill( cosPhi31234, scale );
				histos2D_[ "subjetPolAngle13412vs31234_cutTrigger" ]->Fill( cosPhi13412, cosPhi31234, scale );
				histos2D_[ "subjetPolAngle31234vsSubjetPtRatio_cutTrigger" ]->Fill( cosPhi31234, jet2SubjetPtRatio, scale );
				histos1D_[ "mu1_cutTrigger" ]->Fill( dalitz1[0], scale );
				histos1D_[ "mu2_cutTrigger" ]->Fill( dalitz1[1], scale );
				histos1D_[ "mu3_cutTrigger" ]->Fill( dalitz1[2], scale );
				histos2D_[ "mu1234_cutTrigger" ]->Fill( dalitz1[0], dalitz1[2], scale );
				histos2D_[ "mu1234_cutTrigger" ]->Fill( dalitz1[1], dalitz1[2], scale );
				histos2D_[ "mu1234_cutTrigger" ]->Fill( dalitz1[0], dalitz1[1], scale );
				histos2D_[ "dalitz1234_cutTrigger" ]->Fill( dalitzX1, dalitz1[1], scale );
				histos2D_[ "dalitz1234_cutTrigger" ]->Fill( dalitzX2, dalitz1[2], scale );
				histos2D_[ "dalitz1234_cutTrigger" ]->Fill( dalitzX3, dalitz1[0], scale );
				histos2D_[ "dalitz1234_cutTrigger" ]->Fill( dalitzX4, dalitz1[2], scale );
				histos2D_[ "dalitz1234_cutTrigger" ]->Fill( dalitzX5, dalitz1[0], scale );
				histos2D_[ "dalitz1234_cutTrigger" ]->Fill( dalitzX6, dalitz1[1], scale );

				histos1D_[ "mu4_cutTrigger" ]->Fill( dalitz2[0], scale );
				histos1D_[ "mu5_cutTrigger" ]->Fill( dalitz2[1], scale );
				histos1D_[ "mu6_cutTrigger" ]->Fill( dalitz2[2], scale );
				histos2D_[ "mu3412_cutTrigger" ]->Fill( dalitz2[0], dalitz2[2], scale );
				histos2D_[ "mu3412_cutTrigger" ]->Fill( dalitz2[1], dalitz2[2], scale );
				histos2D_[ "mu3412_cutTrigger" ]->Fill( dalitz2[0], dalitz2[1], scale );
				histos2D_[ "dalitz3412_cutTrigger" ]->Fill( dalitzY1, dalitz2[1], scale );
				histos2D_[ "dalitz3412_cutTrigger" ]->Fill( dalitzY2, dalitz2[2], scale );
				histos2D_[ "dalitz3412_cutTrigger" ]->Fill( dalitzY3, dalitz2[0], scale );
				histos2D_[ "dalitz3412_cutTrigger" ]->Fill( dalitzY4, dalitz2[2], scale );
				histos2D_[ "dalitz3412_cutTrigger" ]->Fill( dalitzY5, dalitz2[0], scale );
				histos2D_[ "dalitz3412_cutTrigger" ]->Fill( dalitzY6, dalitz2[1], scale );
...
void RUNBoostedAnalysis::beginJob() {
	...
	if (mkTree) {
		...
		RUNAtree->Branch( "numJets", &numJets, "numJets/F" );
		RUNAtree->Branch( "numPV", &numPV, "numPV/F" );
	...
	histos1D_[ "jetMass_cutTrigger_Ptsort" ] = fs_->make< TH1D >( "jetMass_cutTrigger_Ptsort", "jetMass_cutTrigger_Ptsort", 60, 0., 600. );
	histos1D_[ "jetMass_cutTrigger_Ptsort" ]->Sumw2();
	...
	histos1D_[ "massAsymmetry_cutTrigger" ] = fs_->make< TH1D >( "massAsymmetry_cutTrigger", "massAsymmetry_cutTrigger", 20, 0., 1. );
	histos1D_[ "massAsymmetry_cutTrigger" ]->Sumw2();
	histos1D_[ "massAve_cutTrigger" ] = fs_->make< TH1D >( "massAve_cutTrigger", "massAve_cutTrigger", 60, 0., 600. );
	histos1D_[ "massAve_cutTrigger" ]->Sumw2();
	histos1D_[ "massAveLowPU_cutTrigger" ] = fs_->make< TH1D >( "massAveLowPU_cutTrigger", "massAveLowPU_cutTrigger", 60, 0., 600. );
	histos1D_[ "massAveLowPU_cutTrigger" ]->Sumw2();
	histos1D_[ "massAveMedPU_cutTrigger" ] = fs_->make< TH1D >( "massAveMedPU_cutTrigger", "massAveMedPU_cutTrigger", 60, 0., 600. );
	histos1D_[ "massAveMedPU_cutTrigger" ]->Sumw2();
	histos1D_[ "massAveHighPU_cutTrigger" ] = fs_->make< TH1D >( "massAveHighPU_cutTrigger", "massAveHighPU_cutTrigger", 60, 0., 600. );
	histos1D_[ "massAveHighPU_cutTrigger" ]->Sumw2();
	histos2D_[ "massAvevsJet1Mass_cutTrigger" ] = fs_->make< TH2D >( "massAvevsJet1Mass_cutTrigger", "massAvevsJet1Mass_cutTrigger", 60, 0., 600., 30, 0., 300. );
	histos2D_[ "massAvevsJet1Mass_cutTrigger" ]->Sumw2();
	histos2D_[ "massAvevsJet2Mass_cutTrigger" ] = fs_->make< TH2D >( "massAvevsJet2Mass_cutTrigger", "massAvevsJet2Mass_cutTrigger", 60, 0., 600., 30, 0., 300. );
	histos2D_[ "massAvevsJet2Mass_cutTrigger" ]->Sumw2();
	histos2D_[ "jet1vs2Mass_cutTrigger" ] = fs_->make< TH2D >( "jet1vs2Mass_cutTrigger", "jet1vs2Mass_cutTrigger", 60, 0., 600., 30, 0., 300. );
	histos2D_[ "jet1vs2Mass_cutTrigger" ]->Sumw2();
	histos1D_[ "cosThetaStar_cutTrigger" ] = fs_->make< TH1D >( "cosThetaStar_cutTrigger", "cosThetaStar_cutTrigger", 20, 0., 1. );
	histos1D_[ "cosThetaStar_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Tau1_cutTrigger" ] = fs_->make< TH1D >( "jet1Tau1_cutTrigger", "jet1Tau1_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet1Tau1_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Tau2_cutTrigger" ] = fs_->make< TH1D >( "jet1Tau2_cutTrigger", "jet1Tau2_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet1Tau2_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Tau3_cutTrigger" ] = fs_->make< TH1D >( "jet1Tau3_cutTrigger", "jet1Tau3_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet1Tau3_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Tau21_cutTrigger" ] = fs_->make< TH1D >( "jet1Tau21_cutTrigger", "jet1Tau21_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet1Tau21_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Tau31_cutTrigger" ] = fs_->make< TH1D >( "jet1Tau31_cutTrigger", "jet1Tau31_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet1Tau31_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Tau32_cutTrigger" ] = fs_->make< TH1D >( "jet1Tau32_cutTrigger", "jet1Tau32_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet1Tau32_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Subjet1Pt_cutTrigger" ] = fs_->make< TH1D >( "jet1Subjet1Pt_cutTrigger", "jet1Subjet1Pt_cutTrigger", 100, 0., 1000. );
	histos1D_[ "jet1Subjet1Pt_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Subjet2Pt_cutTrigger" ] = fs_->make< TH1D >( "jet1Subjet2Pt_cutTrigger", "jet1Subjet2Pt_cutTrigger", 100, 0., 1000. );
	histos1D_[ "jet1Subjet2Pt_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1SubjetPtRatio_cutTrigger" ] = fs_->make< TH1D >( "jet1SubjetPtRatio_cutTrigger", "jet1SubjetPtRatio_cutTrigger", 20, 0, 1.);
	histos1D_[ "jet1SubjetPtRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1SubjetMass21Ratio_cutTrigger" ] = fs_->make< TH1D >( "jet1SubjetMass21Ratio_cutTrigger", "jet1SubjetMass21Ratio_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet1SubjetMass21Ratio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Subjet112MassRatio_cutTrigger" ] = fs_->make< TH1D >( "jet1Subjet112MassRatio_cutTrigger", "jet1Subjet112MassRatio_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet1Subjet112MassRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Subjet1JetMassRatio_cutTrigger" ] = fs_->make< TH1D >( "jet1Subjet1JetMassRatio_cutTrigger", "jet1Subjet1JetMassRatio_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet1Subjet1JetMassRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Subjet212MassRatio_cutTrigger" ] = fs_->make< TH1D >( "jet1Subjet212MassRatio_cutTrigger", "jet1Subjet212MassRatio_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet1Subjet212MassRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Subjet2JetMassRatio_cutTrigger" ] = fs_->make< TH1D >( "jet1Subjet2JetMassRatio_cutTrigger", "jet1Subjet2JetMassRatio_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet1Subjet2JetMassRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Subjet1Mass_cutTrigger" ] = fs_->make< TH1D >( "jet1Subjet1Mass_cutTrigger", "jet1Subjet1Mass_cutTrigger", 20, 0., 100. );
	histos1D_[ "jet1Subjet1Mass_cutTrigger" ]->Sumw2();
	histos1D_[ "jet1Subjet2Mass_cutTrigger" ] = fs_->make< TH1D >( "jet1Subjet2Mass_cutTrigger", "jet1Subjet2Mass_cutTrigger", 20, 0., 100. );
	histos1D_[ "jet1Subjet2Mass_cutTrigger" ]->Sumw2();
	histos2D_[ "jet1Subjet12Mass_cutTrigger" ] = fs_->make< TH2D >( "jet1Subjet12Mass_cutTrigger", "jet1Subjet12Mass_cutTrigger", 20, 0., 100., 20, 0., 100. );
	histos2D_[ "jet1Subjet12Mass_cutTrigger" ]->Sumw2();
	histos2D_[ "jet1Subjet112vs212MassRatio_cutTrigger" ] = fs_->make< TH2D >( "jet1Subjet112vs212MassRatio_cutTrigger", "jet1Subjet112vs212MassRatio_cutTrigger", 20, 0., 1., 20, 0., 1. );
	histos2D_[ "jet1Subjet112vs212MassRatio_cutTrigger" ]->Sumw2();
	histos2D_[ "jet1Subjet1JetvsSubjet2JetMassRatio_cutTrigger" ] = fs_->make< TH2D >( "jet1Subjet1JetvsSubjet2JetMassRatio_cutTrigger", "jet1Subjet1JetvsSubjet2JetMassRatio_cutTrigger", 20, 0., 1., 20, 0., 1. );
	histos2D_[ "jet1Subjet1JetvsSubjet2JetMassRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet2Subjet1Pt_cutTrigger" ] = fs_->make< TH1D >( "jet2Subjet1Pt_cutTrigger", "jet2Subjet1Pt_cutTrigger", 100, 0., 1000. );
	histos1D_[ "jet2Subjet1Pt_cutTrigger" ]->Sumw2();
	histos1D_[ "jet2Subjet2Pt_cutTrigger" ] = fs_->make< TH1D >( "jet2Subjet2Pt_cutTrigger", "jet2Subjet2Pt_cutTrigger", 100, 0., 1000. );
	histos1D_[ "jet2Subjet2Pt_cutTrigger" ]->Sumw2();
	histos1D_[ "jet2SubjetPtRatio_cutTrigger" ] = fs_->make< TH1D >( "jet2SubjetPtRatio_cutTrigger", "jet2SubjetPtRatio_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet2SubjetPtRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet2SubjetMass21Ratio_cutTrigger" ] = fs_->make< TH1D >( "jet2SubjetMass21Ratio_cutTrigger", "jet2SubjetMass21Ratio_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet2SubjetMass21Ratio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet2Subjet112MassRatio_cutTrigger" ] = fs_->make< TH1D >( "jet2Subjet112MassRatio_cutTrigger", "jet2Subjet112MassRatio_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet2Subjet112MassRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet2Subjet1JetMassRatio_cutTrigger" ] = fs_->make< TH1D >( "jet2Subjet1JetMassRatio_cutTrigger", "jet2Subjet1JetMassRatio_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet2Subjet1JetMassRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet2Subjet212MassRatio_cutTrigger" ] = fs_->make< TH1D >( "jet2Subjet212MassRatio_cutTrigger", "jet2Subjet212MassRatio_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet2Subjet212MassRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet2Subjet2JetMassRatio_cutTrigger" ] = fs_->make< TH1D >( "jet2Subjet2JetMassRatio_cutTrigger", "jet2Subjet2JetMassRatio_cutTrigger", 20, 0., 1. );
	histos1D_[ "jet2Subjet2JetMassRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "jet2Subjet1Mass_cutTrigger" ] = fs_->make< TH1D >( "jet2Subjet1Mass_cutTrigger", "jet2Subjet1Mass_cutTrigger", 20, 0., 100.);
	histos1D_[ "jet2Subjet1Mass_cutTrigger" ]->Sumw2();
	histos1D_[ "jet2Subjet2Mass_cutTrigger" ] = fs_->make< TH1D >( "jet2Subjet2Mass_cutTrigger", "jet2Subjet2Mass_cutTrigger", 20, 0., 100. );
	histos1D_[ "jet2Subjet2Mass_cutTrigger" ]->Sumw2();
	histos2D_[ "jet2Subjet12Mass_cutTrigger" ] = fs_->make< TH2D >( "jet2Subjet12Mass_cutTrigger", "jet2Subjet12Mass_cutTrigger", 20, 0., 100., 20, 0., 100. );
	histos2D_[ "jet2Subjet12Mass_cutTrigger" ]->Sumw2();
	histos2D_[ "jet2Subjet112vs212MassRatio_cutTrigger" ] = fs_->make< TH2D >( "jet2Subjet112vs212MassRatio_cutTrigger", "jet2Subjet112vs212MassRatio_cutTrigger", 20, 0., 1., 20, 0., 1. );
	histos2D_[ "jet2Subjet112vs212MassRatio_cutTrigger" ]->Sumw2();
	histos2D_[ "jet2Subjet1JetvsSubjet2JetMassRatio_cutTrigger" ] = fs_->make< TH2D >( "jet2Subjet1JetvsSubjet2JetMassRatio_cutTrigger", "jet2Subjet1JetvsSubjet2JetMassRatio_cutTrigger", 20, 0., 1., 20, 0., 1. );
	histos2D_[ "jet2Subjet1JetvsSubjet2JetMassRatio_cutTrigger" ]->Sumw2();

	histos1D_[ "subjetPtRatio_cutTrigger" ] = fs_->make< TH1D >( "subjetPtRatio_cutTrigger", "subjetPtRatio_cutTrigger", 20, 0., 1. );
	histos1D_[ "subjetPtRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "subjetMass21Ratio_cutTrigger" ] = fs_->make< TH1D >( "subjetMass21Ratio_cutTrigger", "subjetMass21Ratio_cutTrigger", 20, 0., 1. );
	histos1D_[ "subjetMass21Ratio_cutTrigger" ]->Sumw2();
	histos1D_[ "subjet112MassRatio_cutTrigger" ] = fs_->make< TH1D >( "subjet112MassRatio_cutTrigger", "subjet112MassRatio_cutTrigger", 20, 0., 1. );
	histos1D_[ "subjet112MassRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "subjet212MassRatio_cutTrigger" ] = fs_->make< TH1D >( "subjet212MassRatio_cutTrigger", "subjet212MassRatio_cutTrigger", 20, 0., 1. );
	histos1D_[ "subjet212MassRatio_cutTrigger" ]->Sumw2();
	histos2D_[ "subjet12Mass_cutTrigger" ] = fs_->make< TH2D >( "subjet12Mass_cutTrigger", "subjet12Mass_cutTrigger", 20, 0., 100., 20, 0., 100. );
	histos2D_[ "subjet12Mass_cutTrigger" ]->Sumw2();
	histos2D_[ "dijetCorr_cutTrigger" ] = fs_->make< TH2D >( "dijetCorr_cutTrigger", "dijetCorr_cutTrigger", 56, -3.5, 3.5, 56, -3.5, 3.5 );
	histos2D_[ "dijetCorr_cutTrigger" ]->Sumw2();
	histos2D_[ "dijetCorrPhi_cutTrigger" ] = fs_->make< TH2D >( "dijetCorrPhi_cutTrigger", "dijetCorrPhi_cutTrigger", 56, -3.5, 3.5, 56, -3.5, 3.5 );
	histos2D_[ "dijetCorrPhi_cutTrigger" ]->Sumw2();
	histos2D_[ "subjet112vs212MassRatio_cutTrigger" ] = fs_->make< TH2D >( "subjet112vs212MassRatio_cutTrigger", "subjet112vs212MassRatio_cutTrigger", 20, 0., 1., 20, 0., 1. );
	histos2D_[ "subjet112vs212MassRatio_cutTrigger" ]->Sumw2();
	histos2D_[ "subjet1JetvsSubjet2JetMassRatio_cutTrigger" ] = fs_->make< TH2D >( "subjet1JetvsSubjet2JetMassRatio_cutTrigger", "subjet1JetvsSubjet2JetMassRatio_cutTrigger", 20, 0., 1., 20, 0., 1. );
	histos2D_[ "subjet1JetvsSubjet2JetMassRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "subjetPolAngle13412_cutTrigger" ] = fs_->make< TH1D >( "subjetPolAngle13412_cutTrigger", "subjetPolAngle13412_cutTrigger", 100, 0., 1. );
	histos1D_[ "subjetPolAngle13412_cutTrigger" ]->Sumw2();
	histos1D_[ "subjetPolAngle31234_cutTrigger" ] = fs_->make< TH1D >( "subjetPolAngle31234_cutTrigger", "subjetPolAngle31234_cutTrigger", 100, 0., 1. );
	histos1D_[ "subjetPolAngle31234_cutTrigger" ]->Sumw2();
	histos2D_[ "subjetPolAngle13412vs31234_cutTrigger" ] = fs_->make< TH2D >( "subjetPolAngle13412vs31234_cutTrigger", "subjetPolAngle13412vs31234_cutTrigger", 100, 0., 1., 100, 0., 1. );
	histos2D_[ "subjetPolAngle13412vs31234_cutTrigger" ]->Sumw2();
	histos2D_[ "subjetPolAngle13412vsSubjetPtRatio_cutTrigger" ] = fs_->make< TH2D >( "subjetPolAngle13412vsSubjetPtRatio_cutTrigger", "subjetPolAngle13412vsSubjetPtRatio_cutTrigger", 100, 0., 1., 20, 0., 1. );
	histos2D_[ "subjetPolAngle13412vsSubjetPtRatio_cutTrigger" ]->Sumw2();
	histos2D_[ "subjetPolAngle31234vsSubjetPtRatio_cutTrigger" ] = fs_->make< TH2D >( "subjetPolAngle31234vsSubjetPtRatio_cutTrigger", "subjetPolAngle31234vsSubjetPtRatio_cutTrigger", 100, 0., 1., 20, 0., 1. );
	histos2D_[ "subjetPolAngle31234vsSubjetPtRatio_cutTrigger" ]->Sumw2();
	histos1D_[ "mu1_cutTrigger" ] = fs_->make< TH1D >( "mu1_cutTrigger", "mu1_cutTrigger", 150, 0., 1.5 );
	histos1D_[ "mu1_cutTrigger" ]->Sumw2();
	histos1D_[ "mu2_cutTrigger" ] = fs_->make< TH1D >( "mu2_cutTrigger", "mu2_cutTrigger", 150, 0., 1.5 );
	histos1D_[ "mu2_cutTrigger" ]->Sumw2();
	histos1D_[ "mu3_cutTrigger" ] = fs_->make< TH1D >( "mu3_cutTrigger", "mu3_cutTrigger", 150, 0., 1.5 );
	histos1D_[ "mu3_cutTrigger" ]->Sumw2();
	histos2D_[ "mu1234_cutTrigger" ] = fs_->make< TH2D >( "mu1234_cutTrigger", "mu1234_cutTrigger", 150, 0., 1.5, 150, 0., 1.5 );
	histos2D_[ "mu1234_cutTrigger" ]->Sumw2();
	histos2D_[ "dalitz1234_cutTrigger" ] = fs_->make< TH2D >( "dalitz1234_cutTrigger", "dalitz1234_cutTrigger", 150, 0., 1.5, 150, 0., 1.5 );
	histos2D_[ "dalitz1234_cutTrigger" ]->Sumw2();
	histos1D_[ "mu4_cutTrigger" ] = fs_->make< TH1D >( "mu4_cutTrigger", "mu4_cutTrigger", 150, 0., 1.5 );
	histos1D_[ "mu4_cutTrigger" ]->Sumw2();
	histos1D_[ "mu5_cutTrigger" ] = fs_->make< TH1D >( "mu5_cutTrigger", "mu5_cutTrigger", 150, 0., 1.5 );
	histos1D_[ "mu5_cutTrigger" ]->Sumw2();
	histos1D_[ "mu6_cutTrigger" ] = fs_->make< TH1D >( "mu6_cutTrigger", "mu6_cutTrigger", 150, 0., 1.5 );
	histos1D_[ "mu6_cutTrigger" ]->Sumw2();
	histos2D_[ "mu3412_cutTrigger" ] = fs_->make< TH2D >( "mu3412_cutTrigger", "mu3412_cutTrigger", 150, 0., 1.5, 150, 0., 1.5 );
	histos2D_[ "mu3412_cutTrigger" ]->Sumw2();
	histos2D_[ "dalitz3412_cutTrigger" ] = fs_->make< TH2D >( "dalitz3412_cutTrigger", "dalitz3412_cutTrigger", 150, 0., 1.5, 150, 0., 1.5 );
	histos2D_[ "dalitz3412_cutTrigger" ]->Sumw2();

	histos1D_[ "massAve_cutAsym" ] = fs_->make< TH1D >( "massAve_cutAsym", "massAve_cutAsym", 60, 0., 600. );
	histos1D_[ "massAve_cutAsym" ]->Sumw2();
	histos1D_[ "massAveLowPU_cutAsym" ] = fs_->make< TH1D >( "massAveLowPU_cutAsym", "massAveLowPU_cutAsym", 60, 0., 600. );
	histos1D_[ "massAveLowPU_cutAsym" ]->Sumw2();
	histos1D_[ "massAveMedPU_cutAsym" ] = fs_->make< TH1D >( "massAveMedPU_cutAsym", "massAveMedPU_cutAsym", 60, 0., 600. );
	histos1D_[ "massAveMedPU_cutAsym" ]->Sumw2();
	histos1D_[ "massAveHighPU_cutAsym" ] = fs_->make< TH1D >( "massAveHighPU_cutAsym", "massAveHighPU_cutAsym", 60, 0., 600. );
	...
	histos1D_[ "massAveLowPU_cutCosTheta" ] = fs_->make< TH1D >( "massAveLowPU_cutCosTheta", "massAveLowPU_cutCosTheta", 60, 0., 600. );
	histos1D_[ "massAveLowPU_cutCosTheta" ]->Sumw2();
	histos1D_[ "massAveMedPU_cutCosTheta" ] = fs_->make< TH1D >( "massAveMedPU_cutCosTheta", "massAveMedPU_cutCosTheta", 60, 0., 600. );
	histos1D_[ "massAveMedPU_cutCosTheta" ]->Sumw2();
	histos1D_[ "massAveHighPU_cutCosTheta" ] = fs_->make< TH1D >( "massAveHighPU_cutCosTheta", "massAveHighPU_cutCosTheta", 60, 0., 600. );
	...
	histos1D_[ "massAveLowPU_cutSubjetPtRatio" ] = fs_->make< TH1D >( "massAveLowPU_cutSubjetPtRatio", "massAveLowPU_cutSubjetPtRatio", 60, 0., 600. );
	histos1D_[ "massAveLowPU_cutSubjetPtRatio" ]->Sumw2();
	histos1D_[ "massAveMedPU_cutSubjetPtRatio" ] = fs_->make< TH1D >( "massAveMedPU_cutSubjetPtRatio", "massAveMedPU_cutSubjetPtRatio", 60, 0., 600. );
	histos1D_[ "massAveMedPU_cutSubjetPtRatio" ]->Sumw2();
	histos1D_[ "massAveHighPU_cutSubjetPtRatio" ] = fs_->make< TH1D >( "massAveHighPU_cutSubjetPtRatio", "massAveHighPU_cutSubjetPtRatio", 60, 0., 600. );
