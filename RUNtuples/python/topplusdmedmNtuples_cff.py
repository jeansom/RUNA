...
substructure = (
    ...
    quantity = cms.untracked.string("userFloat('NjettinessAK8:tau4')")
    ),
    cms.PSet(
    tag = cms.untracked.string("Tau5"),
    quantity = cms.untracked.string("userFloat('NjettinessAK8:tau5')")
    ),
    cms.PSet(
...
### ak8jets
ak8jets = copy.deepcopy(basic)
ak8jets.variables += jetVars
ak8jets.variables += substructure
ak8jets.prefix = cms.untracked.string("ak8jet")
ak8jets.src = cms.InputTag("patJetsAK8PFCHS")
...
edmNtuplesOut = cms.OutputModule(
    "PoolOutputModule",
    fileName = cms.untracked.string('EDMNtuples.root'),
