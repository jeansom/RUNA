...
process.source = cms.Source("PoolSource",
		    dropDescendantsOfDroppedBranches = cms.untracked.bool(False),
		        fileNames = cms.untracked.vstring(
					    #'file:/afs/cern.ch/user/a/algomez/workingArea/RPVStops/CMSSW_7_1_25_patch1/src/RUNA/RUNSimulation/test/EXO-RunIISummer15wmLHEGS-03775.root'),
					                '/store/user/algomez/RPVStopStopToJets_UDD323_M-400_TuneCUETP8M1_13TeV-madgraph-pythia8/GENSIM_Moriond17/161220_120323/0000/EXO-RunIISummer15wmLHEGS-03775_15.root',
								    '/store/user/algomez/RPVStopStopToJets_UDD323_M-400_TuneCUETP8M1_13TeV-madgraph-pythia8/GENSIM_Moriond17/161220_120323/0000/EXO-RunIISummer15wmLHEGS-03775_16.root',
								    	    ),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
		    dataset = cms.untracked.PSet(
			    ...
			    fileName = cms.untracked.string('file:step_RAWSIM_bumpHunt.root'),
