...
# with command line options: step3 --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --era Run2_2016 --filein file:step_AODSIM_bumpHunt.root --fileout file:step_MINIAODSIM_bumpHunt.root --python_filename step3_MiniAOD_v8020.py
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step_AODSIM_bumpHunt.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step_MINIAODSIM_bumpHunt.root'),
